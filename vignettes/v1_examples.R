...
container2 %<>% add_as_text(
    c("Use `add_as_code_to_eval` to add unquoted code to manipulate the dataset ",
      "'cars_data', e.g. print its variable names or plot it."))
container2 %<>% add_as_code_to_eval(print(names(cars_data[1:3])))
container2 %<>% add_as_code_to_eval(plot(cars_data[1:3]))
