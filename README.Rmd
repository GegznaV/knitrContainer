...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/knitrContainer)](https://cran.r-project.org/package=knitrContainer)  
[![GitHub version](https://img.shields.io/badge/GitHub-v`r packageVersion("knitrContainer")`-brightgreen.svg)](https://github.com/GegznaV/knitrContainer)
...
`knitrContainer` is an [R](https://cran.r-project.org/) package. Its purpose is
to collect objects (*especially* those generated in loops) and print them in [`knitr`](http://yihui.name/knitr/) - [R Markdown](http://rmarkdown.rstudio.com/) reports.
...
Only 4 actions (in short: _"CASP"_) should be done for basic use of `knitrContainer` package:
...
4. **Print** the collected objects appropriately by applying
...
* * *
 ...
 <p align="right"> 
 File updated on <b>`r Sys.Date()`</b> with version of package  <b>`r packageVersion("knitrContainer")`</b>
 </p>    
